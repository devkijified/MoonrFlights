        ...
        <div className="bg-gray-50 rounded-lg p-3 mb-4">
          <div className="grid grid-cols-2 gap-3 text-sm">
            <div>
              ...
              <p className="font-medium text-gray-900">{flight.passenger1_name}</p>
            </div>
            <div>
              <p className="text-xs text-gray-500">Created</p>
              <p className="font-medium text-gray-900">{createdDate}</p>
            </div>
            {flight.passenger2_name && (
              <div className="col-span-2">
                <p className="text-xs text-gray-500">Additional Passenger</p>
                <p className="font-medium text-gray-900">{flight.passenger2_name}</p>
              </div>
            )}
